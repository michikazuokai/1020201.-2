...
\vspace{0.4em}
\begin{block}{\ruby{帰無仮説}{きむかせつ}（$H_0$）}
...
\vspace{0.4em}
\begin{block}{\ruby{対立仮説}{たいりつかせつ}（$H_1$）}
...
\vspace{0.6em}
\begin{block}{\ruby{有意水準}{ゆういすいじゅん}（例）}
\textbf{5\%}（0.05）など：\\
